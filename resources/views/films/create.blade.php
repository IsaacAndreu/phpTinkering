...
<div class="max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
    <h1 class="text-2xl font-bold mb-4">Afegir una nova pel·licula</h1>
    <form action="/films/store" method="POST"> <!-- Cambiat a /films/store -->
        <div class="mb-4">
        ...
        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Afegir una nova pel·licula</button> <!-- Botó de tipus submit -->
    </form>
</div>
</body>
</html>
